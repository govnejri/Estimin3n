## Estimin3n — ASR/LLM набор скриптов для дообучения, инференса и бенчмарков

Estimin3n — это набор утилит на базе Hugging Face Transformers, Unsloth и TRL для:
- дообучения аудио-языковой модели Gemma 3N на собственных данных,
- инференса (ASR/response) с использованием локально сохранённой модели,
- оценки качества на аудио-датасетах (WER/CER) и KazMMLU.
